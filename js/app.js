(() => {
    ...
    da.init();
    const banners = document.querySelectorAll(".order__marquee");
    function animateBanner(banner) {
        const bannerContent = banner.querySelector(".order__title");
        const originalContent = bannerContent.innerHTML;
        bannerContent.innerHTML += originalContent;
        let position = 0;
        const speed = 4;
